            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h1 class="text-white text-center">SIGAP</h1>
                        ...
                        <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
                            <div class="input-group input-group-lg">
                                ...
                                <input name="noKTP" type="search" class="form-control" id="keyword"
                                    placeholder="Masukkan Nomor KTP.." aria-label="Search">
        ...
        <section class="featured-section">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    @if ($dataPegawai && $dataPegawai !== 'not found')
                        <div class="col">
                            <div class="custom-block bg-white shadow-lg">
                                <div class="">
                                    <div>
                                        <h5 class="mb-2">Detail Pegawai</h5>
                                    </div>

                                    @php
                                        $statusExpired = '';

                                        if (date('Y-m-d') >= $dataPegawai->expiredSK) {
                                            $statusExpired = 'Expired';
                                        } else {
                                            $date1 = $dataPegawai->expiredSK;
                                            $date2 = date('Y-m-d');
                                        ...
                                        <div class="card-body pt-4">
                                            <div class="row g-6">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="text-bold">
                                                        {{ $dataPegawai->tanggalSK }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="statusExpired" class="form-label">Status
                                                        Expired</label>
                                                    <div class="text-bold">
                                                        {{ $statusExpired }}
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="namaKelurahan" class="form-label">Nama
                                                        Kelurahan</label>
                                                    <div class="text-bold">
                                                        {{ $dataPegawai->namaKelurahan }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="namaKecamatan" class="form-label">Nama
                                                        Kecamatan</label>
                                                    <div class="text-bold">
                                                        {{ $dataPegawai->namaKecamatan }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="namaIzin" class="form-label">Nama Izin</label>
                                                    <div class="text-bold">
                                                        {{ $dataPegawai->namaIzin }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="tipePemohonan" class="form-label">Tipe
                                                        Permohonan</label>
                                                    <div class="text-bold">
                                                        {{ $dataPegawai->tipePermohonan }}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 mb-3 col-12 mb-4 mb-lg-0">
                                        <div class="custom-block bg-white shadow-lg">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3 col-12 mb-4 mb-lg-0">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{ asset('landingpage') }}/images/topics/undraw_Redesign_feedback_re_jvm0.png"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>

                                    <div class="col-lg-4 col-md-6 mb-3 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                <div class="d-flex">
                                                    <div>
                                                ...
                                                <img src="{{ asset('landingpage') }}/images/topics/colleagues-working-cozy-office-medium-shot.png"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="marketing-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 mb-3 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                <div class="d-flex">
                                                    <div>
                                                ...
                                                <img src="{{ asset('landingpage') }}/images/topics/undraw_online_ad_re_ol62.png"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3 col-12 mb-4 mb-lg-3">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{ asset('landingpage') }}/images/topics/undraw_Group_video_re_btu7.png"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3 col-12">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                ...
                                                <img src="{{ asset('landingpage') }}/images/topics/undraw_viral_tweet_gndb.png"
                                                    class="custom-block-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="finance-tab-pane" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 mb-3 col-12 mb-4 mb-lg-0">
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="topics-detail.html">
                                                <div class="d-flex">
                                                    <div>
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-3 col-12">
